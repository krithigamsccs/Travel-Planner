...
//         const base64Photo = reader.result; // This will be the base64 string of the image
...
//             "Content-Type": "application/json",
//           },
//           body: JSON.stringify({ avatar: base64Photo }),
//         });
  
//         const data = await res.json();
//         if (data?.success) {
//           alert(data?.message);
//           setFormData({ ...formData, avatar: base64Photo });
//           dispatch(updateUserSuccess(data?.user));
//           setProfilePhoto(null);
//           return;
//         } else {
